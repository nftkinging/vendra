  ...
  return (
    <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem 2rem', borderBottom: '1px solid var(--border)', backdropFilter: 'blur(20px)', background: 'rgba(10,6,18,0.85)', gap: '1rem' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
        ...
        <a href="https://faucet.circle.com/" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', fontFamily: "'Space Mono', monospace", fontSize: '0.58rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#a78bfa', textDecoration: 'none', border: '1px solid rgba(124,58,237,0.4)', padding: '0.35rem 0.75rem' }}>
          Faucet
        </a>
